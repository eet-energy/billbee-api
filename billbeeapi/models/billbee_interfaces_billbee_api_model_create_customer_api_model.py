...
class BillbeeInterfacesBillbeeAPIModelCreateCustomerApiModel:
    ...
    def from_dictionary(cls, dictionary):
        ...
        address = (
            BillbeeInterfacesBillbeeAPIModelCustomerAddressApiModel.from_dictionary(dictionary.get("Address"))
        ...
        return cls(address, id, name, email, tel_1, tel_2, number, price_group_id, language_id, vat_id, mtype)
