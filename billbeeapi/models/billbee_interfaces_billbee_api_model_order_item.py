...
"""
from billbeeapi.models.billbee_interfaces_billbee_api_model_order_item_attribute import (
    BillbeeInterfacesBillbeeAPIModelOrderItemAttribute,
)
from billbeeapi.models.billbee_interfaces_billbee_api_model_sold_product import (
...
class BillbeeInterfacesBillbeeAPIModelOrderItem:
    ...
    def from_dictionary(cls, dictionary):
        ...
        product = (
            BillbeeInterfacesBillbeeAPIModelSoldProduct.from_dictionary(dictionary.get("Product"))
        ...
        if dictionary.get("Attributes") is not None:
            attributes = [
                BillbeeInterfacesBillbeeAPIModelOrderItemAttribute.from_dictionary(x)
