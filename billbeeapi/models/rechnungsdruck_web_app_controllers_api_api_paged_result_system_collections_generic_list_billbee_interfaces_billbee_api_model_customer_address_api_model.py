...
from billbeeapi.models.rechnungsdruck_web_app_controllers_api_api_paged_result_paging_information_system_collections_generic_list_billbee_interfaces_billbee_api_model_customer_address_api_model import (
...
class RechnungsdruckWebAppControllersApiApiPagedResultSystemCollectionsGenericListBillbeeInterfacesBillbeeAPIModelCustomerAddressApiModel:
    ...
    def from_dictionary(cls, dictionary):
        ...
        paging = (
            RechnungsdruckWebAppControllersApiApiPagedResultPagingInformationSystemCollectionsGenericListBillbeeInterfacesBillbeeAPIModelCustomerAddressApiModel.from_dictionary(
        ...
        if dictionary.get("Data") is not None:
            data = [
                BillbeeInterfacesBillbeeAPIModelCustomerAddressApiModel.from_dictionary(x)
