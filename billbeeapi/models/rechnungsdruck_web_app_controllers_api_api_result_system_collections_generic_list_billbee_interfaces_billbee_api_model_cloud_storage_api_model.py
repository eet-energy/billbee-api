...
"""
from billbeeapi.models.billbee_interfaces_billbee_api_model_cloud_storage_api_model import BillbeeInterfacesBillbeeAPIModelCloudStorageApiModel


class RechnungsdruckWebAppControllersApiApiResultSystemCollectionsGenericListBillbeeInterfacesBillbeeAPIModelCloudStorageApiModel(object):
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('Data') is not None:
            data = [BillbeeInterfacesBillbeeAPIModelCloudStorageApiModel.from_dictionary(x) for x in dictionary.get('Data')]
